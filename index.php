    ...
    <main>
      <section class="section" id="section1">
        ...
        <article id="DescriptionG">
          ...
          <span id="titleG">
            <h2>Rejoins <br/>la Mission <br/>APOLLO <br/>GIF !</h2>
          </span>
          <div id="buttonContainer" style="color:white;margin: 40px;">
            ...
            <div class="btn">
              ...
              <a href="#section2">
                <button class="orderbtn"><span id="btn-rocket" class="icon-rocket"></span>Découvrir La Mission</button>
              </a>
            </div>
            <div class="btn">
              <div class="ctrltitle">FOOD SUP.</div>
              <a href="https://crepes-cs.fr/">
                <button class="orderbtn"><span id="btn-cart" class="icon-cart"></span>Commander des CRÊPES</button>
              </a>
            </div>
          </div>
        </article>
